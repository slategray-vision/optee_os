 ...
 * corrected-space region entry (e.g. the PIL_ARB enable/version and PK_HASH
 * words); each caller documents why direct access is required.
 */
 ...
 * encryption (UIE) is provisioned on the device. Same register/bit on lemans
 * and kodiak.
 */
