...
/*
 * Signing authority required for an image. PAS_QTI_SIGNED completes the
 * authority taxonomy; pas_policy_signer() currently returns only
 * PAS_OEM_SIGNED or PAS_DOUBLE_SIGNED.
 */
